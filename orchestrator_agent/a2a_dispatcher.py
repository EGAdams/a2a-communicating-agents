...
class A2ADispatcher:
    ...
    def __init__(self, workspace_root: Path, memory_factory=None, document_manager_cls=None) -> None:
        self.hub = A2ACollectiveHub(
            workspace_root=workspace_root,
            memory_factory=memory_factory,
            document_manager_cls=document_manager_cls,
        )
